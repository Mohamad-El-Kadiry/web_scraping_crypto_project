    ...
    try:
        ...
        try:
            current_price = driver.find_element(By.XPATH,
                '//*[@id="gecko-coin-page-container"]/div[4]/div/div[1]/div[2]/div[1]/span').text.strip()
        except Exception:
            current_price = "N/A"
