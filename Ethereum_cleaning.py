...
def ethereum_data_cleaning():
    df = pd.read_csv('ethereum_data.csv')  # Make sure this path matches your Ethereum raw data file
    ...
    # Select final cleaned columns with time features
    ...
    print("✅ Ethereum data cleaned and saved to 'ethereum_data_cleaned.csv'!")

# Run the cleaning function
ethereum_data_cleaning()
