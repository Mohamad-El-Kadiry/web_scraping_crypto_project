...
def bitcoin_data_cleaning():
    ...
    # Save to CSV
    df_cleaned.to_csv('Bitcoin_cleaned.csv', index=False)
    print("Bitcoin data cleaned and saved to 'Bitcoin_cleaned.csv'!")

# Run the cleaning
bitcoin_data_cleaning()
